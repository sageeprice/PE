...
public class EulerFastTests {
    ...
    public void verifyFastProblems() {
        ...
        assertEquals(new Euler101().solve(), "37076114526");
        assertEquals(new Euler102().solve(), "228");
        assertEquals(new Euler104().solve(), "329468");
        assertEquals(new Euler105().solve(), "73702");
        assertEquals(new Euler106().solve(), "21384");
        assertEquals(new Euler107().solve(), "259679");
        assertEquals(new Euler108().solve(), "180180");
        assertEquals(new Euler109().solve(), "38182");
        assertEquals(new Euler111().solve(), "612407567715");
        ...
        assertEquals(new Euler134().solve(), "18613426663617118");
        assertEquals(new Euler137().solve(), "1120149658760");
        assertEquals(new Euler139().solve(), "10057761");
        assertEquals(new Euler150().solve(), "-271248680");
        ...
        assertEquals(new Euler225().solve(), "2009");
        ...
        assertEquals(new Euler313().solve(), "2057774861813004");
        assertEquals(new Euler317().solve(), "1856532.8455");
        assertEquals(new Euler323().solve(), "6.3551758451");
        assertEquals(new Euler329().solve(), "199740353/29386561536000");
        assertEquals(new Euler336().solve(), "CAGBIHEFJDK");
        assertEquals(new Euler345().solve(), "13938");
        assertEquals(new Euler346().solve(), "336108797689259276");
        assertEquals(new Euler347().solve(), "11109800204052");
        assertEquals(new Euler358().solve(), "3284144505");
        assertEquals(new Euler371().solve(), "40.66368097");
