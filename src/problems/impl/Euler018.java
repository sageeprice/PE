...
/**
 * Problem 18:
 * Find the maximum total from top to bottom of the triangle below (see PYRAMID)
 *
 * Solved by Sage on 10/14/16.
 */
public class Euler018 implements Problem {
    ...
    @Override
    public String solve() {
        int[][] travel_length = new int[15][15];
        ...
        int best = 0;
        for (int path : travel_length[PYRAMID.length-1]) {
            if (path > best) {
                best = path;
            }
        }
